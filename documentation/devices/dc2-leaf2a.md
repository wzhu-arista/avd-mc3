...
| Ethernet4 | DC2-LEAF2C_Ethernet1 | *trunk | *11-12,21-22 | *- | *- | 4 |
| Ethernet5 | dc2-server2_eth1 | *trunk | *11-12,21-22 | *4092 | *- | 5 |
...
| Vlan3009 |  VRF10  |  10.255.2.98/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3010 |  VRF11  |  10.255.2.98/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4093 |  default  |  10.255.2.98/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  10.255.2.66/31  |  -  |  -  |  -  |  -  |  -  |
...
| 10.255.2.36 | 65200 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 10.255.2.38 | 65200 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 10.255.2.99 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
| 10.255.2.99 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRF10 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
| 10.255.2.99 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRF11 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
...
| ----------------- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ | ----- |
| VRF10 | 10.255.2.4:20010 | 20010:20010 | - | - | learned<br>igmp | 11-12 |
| VRF11 | 10.255.2.4:20011 | 20011:20011 | - | - | learned<br>igmp | 21-22 |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute | EVPN Multicast |
| --- | ------------------- | ------------ | -------------- |
| VRF10 | 10.255.2.4:10 | connected | IPv4: True<br>Transit: False |
| VRF11 | 10.255.2.4:11 | connected | IPv4: True<br>Transit: False |
...
ip igmp snooping vlan 11 querier address 10.255.2.4
ip igmp snooping vlan 12 querier
ip igmp snooping vlan 12 querier address 10.255.2.4
ip igmp snooping vlan 21 querier
ip igmp snooping vlan 21 querier address 10.255.2.4
ip igmp snooping vlan 22 querier
ip igmp snooping vlan 22 querier address 10.255.2.4
```
