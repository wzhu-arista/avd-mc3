...
| Ethernet4 | DC2-LEAF2C_Ethernet1 | *trunk | *201-202 | *- | *- | 4 |
...
| --------- | ----------- | -----| ------- | -------------- |
| Ethernet6.200 | To-RP | l3dot1q | - | 200 |
...
| Ethernet6.200 | To-RP | l3dot1q | - | 10.0.0.6/31 | VRF200 | 1500 | False | - | - |
...
| --- | ------------------- | ------------ | -------------- |
| VRF200 | 10.255.2.4:200 | connected | IPv4: True<br>Transit: True |
...
router bgp 65202
   ...
   vrf VRF200
      ...
      neighbor 10.0.0.7 peer group RP-VRF200
      neighbor 10.0.0.7 description rp-vrf200
