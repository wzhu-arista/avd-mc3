...
| Ethernet4 | DC1-LEAF2C_Ethernet2 | *trunk | *11-12,21-22 | *- | *- | 4 |
| Ethernet5 | dc1-server2_eth2 | *trunk | *11-12,21-22 | *4092 | *- | 5 |
...
| Vlan3009 |  VRF10  |  10.255.1.99/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3010 |  VRF11  |  10.255.1.99/31  |  -  |  -  |  -  |  -  |  -  |
...
| 10.255.1.98 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRF10 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
| 10.255.1.98 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRF11 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
...
| ----------------- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ | ----- |
| VRF10 | 10.255.1.5:20010 | 20010:20010 | - | - | learned<br>igmp | 11-12 |
| VRF11 | 10.255.1.5:20011 | 20011:20011 | - | - | learned<br>igmp | 21-22 |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute | EVPN Multicast |
| --- | ------------------- | ------------ | -------------- |
| VRF10 | 10.255.1.5:10 | connected | IPv4: True<br>Transit: False |
| VRF11 | 10.255.1.5:11 | connected | IPv4: True<br>Transit: False |
...
ip igmp snooping vlan 11 querier address 10.255.1.5
ip igmp snooping vlan 12 querier
ip igmp snooping vlan 12 querier address 10.255.1.5
ip igmp snooping vlan 21 querier
ip igmp snooping vlan 21 querier address 10.255.1.5
ip igmp snooping vlan 22 querier
ip igmp snooping vlan 22 querier address 10.255.1.5
```
