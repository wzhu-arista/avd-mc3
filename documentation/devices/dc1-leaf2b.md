...
| --------- | --------------- | ------------ | --------- |
| DC1_L3_LEAF2 | Vlan4094 | 10.255.1.66 | Port-Channel3 |
...
| 111 | VRF110_VLAN111 | - |
| 112 | VRF110_VLAN112 | - |
| 3099 | MLAG_iBGP_VRF100 | LEAF_PEER_L3 |
| 3109 | MLAG_iBGP_VRF110 | LEAF_PEER_L3 |
...
| Ethernet4 | DC1-LEAF2C_Ethernet2 | *trunk | *101-102,111-112 | *- | *- | 4 |
...
| Port-Channel4 | DC1-LEAF2C_Po1 | switched | trunk | 101-102,111-112 | - | - | - | - | 4 | - |
| Port-Channel5 | dc1-server2_PortChannel dc1-server2 | switched | trunk | 101-102,111-112 | 4092 | - | - | - | 5 | - |
...
| Loopback110 | VRF110_VTEP_DIAGNOSTICS | VRF110 | 10.255.110.5/32 |
...
| Vlan3099 | MLAG_PEER_L3_iBGP: vrf VRF100 | VRF100 | 1500 | False |
| Vlan3109 | MLAG_PEER_L3_iBGP: vrf VRF110 | VRF110 | 1500 | False |
...
| Vlan3099 |  VRF100  |  10.255.1.99/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3109 |  VRF110  |  10.255.1.99/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4093 |  default  |  10.255.1.99/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  10.255.1.67/31  |  -  |  -  |  -  |  -  |  -  |
...
| 10.255.1.98 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
| 10.255.1.98 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRF100 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
| 10.255.1.98 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRF110 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
...
| VRF110 | 10.255.1.5:11110 | 11110:11110 | - | - | learned | 111-112 |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute | EVPN Multicast |
| --- | ------------------- | ------------ | -------------- |
| VRF100 | 10.255.1.5:100 | connected | IPv4: True<br>Transit: False |
| VRF110 | 10.255.1.5:110 | connected | IPv4: True<br>Transit: False |
...
router bgp 65102
   ...
   neighbor 10.255.1.98 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 10.255.1.98 description dc1-leaf2a
...
| Ethernet1 | - | IPv4 | - | - |
| Ethernet2 | - | IPv4 | - | - |
| Vlan101 | VRF100 | IPv4 | - | Loopback100 |
| Vlan102 | VRF100 | IPv4 | - | Loopback100 |
| Vlan111 | VRF110 | IPv4 | - | Loopback110 |
| Vlan112 | VRF110 | IPv4 | - | Loopback110 |
| Vlan4093 | - | IPv4 | - | - |
...
ip address virtual source-nat vrf VRF110 address 10.255.110.5
```
