...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 |  dc2-erver1_eth1 | trunk | 11-12,21-22 | 4092 | - | - |
...
| ----------------- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ | ----- |
| VRF10 | 10.255.2.3:20010 | 20010:20010 | - | - | learned<br>igmp | 11-12 |
| VRF11 | 10.255.2.3:20011 | 20011:20011 | - | - | learned<br>igmp | 21-22 |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute | EVPN Multicast |
| --- | ------------------- | ------------ | -------------- |
| VRF10 | 10.255.2.3:10 | connected | IPv4: True<br>Transit: False |
| VRF11 | 10.255.2.3:11 | connected | IPv4: True<br>Transit: False |
...
ip igmp snooping vlan 11 querier address 10.255.2.3
ip igmp snooping vlan 12 querier
ip igmp snooping vlan 12 querier address 10.255.2.3
ip igmp snooping vlan 21 querier
ip igmp snooping vlan 21 querier address 10.255.2.3
ip igmp snooping vlan 22 querier
ip igmp snooping vlan 22 querier address 10.255.2.3
```
