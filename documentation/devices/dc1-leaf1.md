...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 |  dc1-server1_eth1 | trunk | 11-12,21-22 | 4092 | - | - |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_DC1-SPINE1_Ethernet1 | routed | - | 10.255.1.33/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_LINK_TO_DC1-SPINE2_Ethernet1 | routed | - | 10.255.1.35/31 | default | 1500 | False | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.255.1.3/32 |
...
| 10.255.1.32 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 10.255.1.34 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
...
| ----------------- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ | ----- |
| VRF10 | 10.255.1.3:20010 | 20010:20010 | - | - | learned<br>igmp | 11-12 |
| VRF11 | 10.255.1.3:20011 | 20011:20011 | - | - | learned<br>igmp | 21-22 |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute | EVPN Multicast |
| --- | ------------------- | ------------ | -------------- |
| VRF10 | 10.255.1.3:10 | connected | IPv4: True<br>Transit: False |
| VRF11 | 10.255.1.3:11 | connected | IPv4: True<br>Transit: False |
...
ip igmp snooping vlan 11 querier address 10.255.1.3
ip igmp snooping vlan 12 querier
ip igmp snooping vlan 12 querier address 10.255.1.3
ip igmp snooping vlan 21 querier
ip igmp snooping vlan 21 querier address 10.255.1.3
ip igmp snooping vlan 22 querier
ip igmp snooping vlan 22 querier address 10.255.1.3
```
