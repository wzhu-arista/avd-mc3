...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | oob_management | oob | MGMT | 192.168.124.116/24 | 192.168.124.1 |
...
| Ethernet4 | DC2-LEAF2C_Ethernet2 | *trunk | *201-202,211-212 | *- | *- | 4 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_DC2-SPINE1_Ethernet3 | routed | - | 10.255.2.41/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_LINK_TO_DC2-SPINE2_Ethernet3 | routed | - | 10.255.2.43/31 | default | 1500 | False | - | - |
...
| Loopback210 | VRF210_VTEP_DIAGNOSTICS | VRF210 | 10.255.210.5/32 |
...
| Vlan3209 |  VRF210  |  10.255.2.99/31  |  -  |  -  |  -  |  -  |  -  |
...
| 10.255.2.98 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRF210 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
...
| ----------------- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ | ----- |
| VRF200 | 10.255.2.5:21200 | 21200:21200 | - | - | learned | 201-202 |
| VRF210 | 10.255.2.5:21210 | 21210:21210 | - | - | learned | 211-212 |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute | EVPN Multicast |
| --- | ------------------- | ------------ | -------------- |
| VRF200 | 10.255.2.5:200 | connected | IPv4: True<br>Transit: False |
| VRF210 | 10.255.2.5:210 | connected | IPv4: True<br>Transit: False |
...
ip address virtual source-nat vrf VRF210 address 10.255.210.5
```
